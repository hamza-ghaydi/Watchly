...
import { Star, Plus, Clapperboard } from 'lucide-react';
import type { BreadcrumbItem } from '@/types';

const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Dashboard', href: '/dashboard' },
    { title: 'All Watched', href: '/admin/movies/watched' },
];
...
export default function Watched() {
    ...
    const handleFilterChange = (key: string, value: string) => {
        ...
        router.get(`/admin/movies/watched?${params.toString()}`);
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="All Watched" />
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-white">All Watched</h1>
                        <p className="text-neutral-400 mt-1">Movies and series users have watched</p>
                    </div>
                    <Button
                                    ...
                                    <tr key={`${movie.id}-${movie.user_email}`} className="border-b border-neutral-800 last:border-0">
                                        ...
                                        <td className="p-4">
                                            <div className="flex items-center gap-1 text-[#F5C518]">
                                                ...
                                                <span className="font-semibold">{movie.user_rating}/10</span>
                                            </div>
                                        </td>
